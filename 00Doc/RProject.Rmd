...
===
**This project analyzes the Consumer Financial Complaints data from the ggplot2 package which has been supplemented with additional synthetic data and stored in an Oracle database.**
...
setwd("C:/Users/Amar/Desktop/Fall 2014/378 - Data Science/378_data_science")
system("type .Rprofile", intern = TRUE)
```
...
```{r}
# To get this to work in your environment, change the following directory/folder path to the path to your project files.
setwd("C:/Users/Amar/Desktop/Fall 2014/378 - Data Science/378_data_science/02ComplainData")
...
```{r}
# To get this to work in your environment, change the following directory/folder path to the path to your project files.
setwd("C:\Users\Amar\Desktop\Fall 2014\378 - Data Science\378_data_science\02DiamondsData")
